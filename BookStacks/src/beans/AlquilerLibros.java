...
public class AlquilerLibros {
	...
	public AlquilerLibros(int idLibro, int idAlq, String codAlq, String fechaEntrega,
			String fechaSalida, double montoPagar, int idUsuario,
			String estadoAlq) {
